...
<div class="container-xxl py-5">
    <div class="container wrapper-margin-top">
        <div class="col-sm-12 col-lg-12 col-md-12">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="position: relative">

                <div class="content-header">New Content</div>
            </div>
                    ...
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden" style="height: 270px;">
                            ...
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                ...
                                <a href="./<?php echo $row['post_id'];?>/<?php echo $row['slug'];?>" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;"><?php echo $row['post_title'];?></a>
                            </div>
                        </div>
...
<!--                            <small class="flex-fill text-center border-end py-2">-->
<!--                                <i data-id="--><?php //echo $row['post_id'];?><!--"-->
<!--                                    --><?php //if (isUserLogin()){
//                                        echo 'data-u_id='.$_SESSION['userInfo']['id'];
//                                        if (userDisLiked($row['post_id'], $_SESSION['userInfo']['id'])):?>
<!--                                            style="cursor: pointer" class="fas fa-thumbs-down text-primary me-2 dislikes_results"-->
<!--                                        --><?php //else: ?>
<!--                                            style="cursor: pointer" class="far fa-thumbs-down text-primary me-2 dislikes_results"-->
<!--                                        --><?php //endif;} ?>
<!--                                   style="cursor: pointer" class="far fa-thumbs-down text-primary me-2 dislikes_results"-->
<!--                                >-->
<!--                                </i>-->
...
<!--                            </small>-->
            ...
            <hr>
            <a href="all-post.php" class="btn btn-dark" style="margin:25px; border-radius: 5px; ">More->> </a>
