...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><input type="text" class="form-control"  name="item[]" placeholder="Survey items..."><a href="#" class="remove_field"><i style="color:#ff0000" class="fa fa-trash"></i></a></div>'); //add input box
        }
        else{
            swal({
                title: "Dear user!",
                text: "You can add till 9 inputs",
                icon: "warning",
                button:false,
                timer:3000,
